...
- [x] 3.3 本机目视验证：陨石坑凹凸可见
- [x] 3.4 本机目视验证：粒子环有厚度感
- [x] 3.5 本机目视验证：360° 拖拽无卡顿/反转

## 4. 收尾

- [x] 4.1 OpenSpec validate 通过
- [x] 4.2 提交 atomic commit: `feat(web): enhance hero planet with crater bump, thick ring particles and quaternion drag` — 已提交 1af3847
