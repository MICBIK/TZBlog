...
- And detail pages render from the props generated by `getStaticPaths()` using the same published collection data
...
- Then they get typed functions for collection reads that handle API URL, error handling, and data transformation
